(function ($) {
    $.fn.extend({
        gips: function (options) {
            var settings = $.extend({ delay: 500, autoHide: false, pause: 5000, animationSpeed: 500, placement: 'top', theme: 'purple', imagePath: 'images/close.png', text: 'Onhover Text goes here' }, options);
            return this.each(function () {
                ...
                control.mouseover(function () {
                    ...
                    var left = position.left-170;
                    var top = position.top-290;
                    if (placement == 'top') {
                        top -= toolTip.height();
